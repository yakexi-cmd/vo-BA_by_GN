...
extern vector<Point2f> prev_pts;
extern Mat prev_img;
extern bool init_img;
extern int i_;

extern Mat prev_t,prev_r;
...
private:
    ...
    Mat img_traj_;
    Mat mask_;
    std::map<int,Point2f> prev_pts_map_;
